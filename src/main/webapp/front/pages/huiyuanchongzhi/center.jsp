				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="chongzhijine" id="chongzhijine">
							...
							<div class="layui-input-block">
								<input type="text" name="chongzhishijian" id="chongzhishijian" placeholder="充值时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">账户余额</label>
							<div class="layui-input-block">
								<input type="text" name="zhanghuyue" id="zhanghuyue" placeholder="账户余额" autocomplete="off" class="layui-input">
							</div>
						</div>
