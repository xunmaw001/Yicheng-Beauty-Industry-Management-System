				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>职位名称：</span>
							<span class="desc">
								{{detail.zhiweimingcheng}}
							</span>
						</div>
																								<div class="detail-item">
							<span>从业时间：</span>
							<span class="desc">
								{{detail.congyeshijian}}
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('faxingmeirongshi','预约')" @click="onAcrossTap('jishiyuyue')" type="button" class="layui-btn">
								预约
							</button>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`faxingmeirongshi`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.jishixingming;
																																																		// 轮播图片
					vue.swiperList = vue.detail.zhaopian ? vue.detail.zhaopian.split(",") : [];
																																													var swiperItemHtml = '';
