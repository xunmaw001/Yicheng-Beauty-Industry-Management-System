		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <label class="layui-form-label">技师类型</label>
                        <div class="layui-input-block">
                            <select name="jishileixing" id="jishileixing" lay-filter="jishileixing">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in jishileixing" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.jishixingming" type="text" name="jishixingming" id="jishixingming" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.congyeshijian" type="text" name="congyeshijian" id="congyeshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                								...
                								http.request(`option/jishileixing/jishileixing`,'get',{},(res)=>{
					vue.jishileixing = res.data
				});
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                        if(!isIntNumer(data.congyeshijian)){
                        layer.msg('从业时间应输入整数', {
							time: 2000,
							icon: 5
						});
					...
					// 提交数据
					http.requestJson('faxingmeirongshi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
