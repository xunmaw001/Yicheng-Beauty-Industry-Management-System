					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="jishileixing" id="jishileixing">
							...
							<div class="layui-input-block">
								<input type="text" name="jishixingming" id="jishixingming" placeholder="技师姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">职位名称</label>
							<div class="layui-input-block">
								<input type="text" name="zhiweimingcheng" id="zhiweimingcheng" placeholder="职位名称" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">从业时间</label>
							<div class="layui-input-block">
								<input type="text" name="congyeshijian" id="congyeshijian" placeholder="从业时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
							<div class="layui-input-block">
