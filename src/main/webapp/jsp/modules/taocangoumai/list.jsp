...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">套餐购买管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>套餐购买列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">套餐购买列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('goumaishuliang')">购买数量<i id="goumaishuliangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('zongjine')">总金额<i id="zongjineIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('goumaishijian')">购买时间<i id="goumaishijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var goumaishuliangCell  = document.createElement('td');

						 goumaishuliangCell.innerHTML = item.goumaishuliang;


			row.appendChild(goumaishuliangCell);
			...
			var goumaishijianCell  = document.createElement('td');

						  goumaishijianCell.innerHTML = item.goumaishijian;


			row.appendChild(goumaishijianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("taocangoumai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"taocangoumai");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"taocangoumai");
