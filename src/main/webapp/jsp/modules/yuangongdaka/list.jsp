...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">员工打卡管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>员工打卡列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">员工打卡列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										工号
									</label>
									<input type="text" id="gonghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										姓名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('kaoqinleixing')">考勤类型<i id="kaoqinleixingIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('dakashijian')">打卡时间<i id="dakashijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#gonghaoSearch').val() != null && $('#gonghaoSearch').val() != ''){
				searchForm.gonghao ="%" +  $('#gonghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("yuangongdaka/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				gonghao : searchForm.gonghao,	
		...
		function setDataRow(item,number){
			...
			var kaoqinleixingCell  = document.createElement('td');

						  kaoqinleixingCell.innerHTML = item.kaoqinleixing; 

			row.appendChild(kaoqinleixingCell);
			var dakashijianCell  = document.createElement('td');

						  dakashijianCell.innerHTML = item.dakashijian;


			row.appendChild(dakashijianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yuangongdaka/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yuangongdaka");
