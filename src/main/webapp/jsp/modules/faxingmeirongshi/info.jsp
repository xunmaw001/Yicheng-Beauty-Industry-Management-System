						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jishileixing" name="jishileixing" class="form-control" v-model="ruleForm.jishileixing" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>技师姓名</label>

									<input id="jishixingming" name="jishixingming" class="form-control" v-model="ruleForm.jishixingming" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>职位名称</label>
									...
									<input id="congyeshijian" name="congyeshijian" class="form-control" v-model="ruleForm.congyeshijian" readonly>
									</div>
