...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">会员充值管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>会员充值列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">会员充值列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chongzhijine')">充值金额<i id="chongzhijineIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('chongzhishijian')">充值时间<i id="chongzhishijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('zhanghuyue')">账户余额<i id="zhanghuyueIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var chongzhijineCell  = document.createElement('td');

						  chongzhijineCell.innerHTML = item.chongzhijine; 

			row.appendChild(chongzhijineCell);
			var chongzhishijianCell  = document.createElement('td');

						  chongzhishijianCell.innerHTML = item.chongzhishijian;


			row.appendChild(chongzhishijianCell);
			var zhanghuyueCell  = document.createElement('td');

						 zhanghuyueCell.innerHTML = item.zhanghuyue;


			row.appendChild(zhanghuyueCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("huiyuanchongzhi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"huiyuanchongzhi");
